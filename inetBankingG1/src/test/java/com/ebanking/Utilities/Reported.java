/*
 * package com.ebanking.Utilities; import java.io.File; import
 ...
 * 
 * 
 * // Listner class used to generate extent report... public class Reported
 * extends TestListenerAdapter { public ExtentHtmlReporter htmlReporter; public
 * ExtentReports extent; public ExtentTest logger;
 * 
 * 
 ...
 * logger.log(Status.PASS,MarkupHelper.createLabel(tr.getName(),ExtentColor.
 * GREEN)); // send the passed information to the report with GREEN color
 * highlighted }
 * 
 ...
 * logger=extent.createTest(tr.getName()); // create new entry in th report
 * logger.log(Status.SKIP,MarkupHelper.createLabel(tr.getName(),ExtentColor.
 * ORANGE)); }
 * 
